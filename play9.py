#!/usr/bin/env python3
"""
Query Matcher - Iteration 9 (Optimized play2.C3 with MPNet)
Uses play2.C3's successful approach but with MPNet model
MPNet shows 81% accuracy vs MiniLM's 78% in testing
Target: EXCEED 82.5% with the better embedding model
"""
...
def main():
    ...
    if EMBEDDINGS_AVAILABLE:
        model_name = "all-mpnet-base-v2"  # Using better model!
